      ...
      <div className="flex h-16 items-center border-b border-sidebar-border px-6">
        <div className="flex items-center gap-3">
          <div className="flex h-8 w-8 items-center justify-center rounded bg-sidebar-primary">
            <span className="font-mono text-sm font-bold text-sidebar-primary-foreground">SM</span>
          </div>
          <span className="font-semibold text-sidebar-foreground">Selvedge Mark</span>
        </div>
      </div>
