...
export default function PromotionsPage() {
  ...
  const filteredPromotions = promotions.filter((promo) => promo.code.toLowerCase().includes(searchQuery.toLowerCase()))
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-border bg-card">
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-card-foreground">All Promotions</CardTitle>
          ...
          <Table>
            ...
            <TableBody>
              {filteredPromotions.map((promo) => (
                <TableRow key={promo.id} className="border-border hover:bg-secondary/50">
                  <TableCell className="font-mono font-medium text-foreground">{promo.code}</TableCell>
                  <TableCell className="text-muted-foreground">{promo.type}</TableCell>
                  <TableCell className="text-foreground">{promo.value}</TableCell>
                  <TableCell className="text-muted-foreground">{promo.usage}</TableCell>
